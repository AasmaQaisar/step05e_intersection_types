...
let myType = { name: "Aasma", id: 1 };

//Case 1
myType = { id: 2,  name: "Janny" };//Case 1: can only assign a type which has the the same properties
									//Object literals can only have properties that exist in contextual type


//Case 2a
myType = { id: 2,  name_person: "Janny" };//Case 2a: Error, renamed or missing property
...
var x: { id: number, [x: string]: any };//Note now 'x' can have any name, just that the property should be of type string
var y = { id: 1, fullname: "Aasma" };
x = y;// Ok, `fullname` matched by index signature


var myType4 = { id: 2,  name: "Janny", age: 22 };
